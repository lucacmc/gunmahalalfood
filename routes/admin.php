...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::controller(SlotController::class)->group(function () {
        Route::get('/slots/edit/{id}', 'edit')->name('slots.edit');
        Route::get('/slots/destroy/{id}', 'destroy')->name('slots.destroy');
        Route::post('/slots/status', 'updateStatus')->name('slots.status');
    });
