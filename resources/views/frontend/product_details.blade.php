                                ...
                                <div class="text-left">
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        {{ renderStarRating($detailedProduct->rating) }}
                                            ...
                                            <span
                                                class="ml-1 opacity-50">({{ $total }} {{ translate('reviews')}})</span>
                                        </div>
                                        ...
                                        @if ($detailedProduct->choice_options != null)
                                            @foreach (json_decode($detailedProduct->choice_options) as $key => $choice)
                                                ...
                                                <div class="row no-gutters">
                                                    <div class="col-sm-2">
                                                        <div
                                                            class="opacity-50 my-2">{{ \App\Models\Attribute::find($choice->attribute_id)->getTranslation('name') }}
                                                            :
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-10">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        @else
                                            <button type="button" class="btn btn-soft-primary mr-2 add-to-cart fw-600"
                                                ...
                                                <span
                                                    class="d-none d-md-inline-block"> {{ translate('Add to cart')}}</span>
                                            </button>
                                ...
                                <div class="row gutters-10">
                                    ...
                                    <div class="col-xl-12 order-0 order-xl-1">
                                        ...
                                        <div class="bg-white rounded shadow-sm">
                                            ...
                                            <div class="p-3">
                                                <div class="aiz-carousel gutters-5 half-outside-arrow" data-items="5"
                                                     data-xl-items="3" data-lg-items="4" data-md-items="3"
